    ...
    <section className="py-4 px-4 sm:py-8 sm:px-6" ref={forwardRef}>
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-start sm:justify-center mb-6 sm:mb-8">
          <div className="bg-secondary/50 backdrop-blur-sm border border-border/50 rounded-2xl p-2 flex gap-2 overflow-x-auto snap-x snap-mandatory -mx-4 px-4 sm:mx-0 sm:px-2">
