...
const steps = [
  {
    ...
    timeframe: "Phase 1",
    icon: Search,
    description: "We study your business problem, workflow and existing technology.",
    color: "from-blue-500/20 to-blue-500/0",
    iconColor: "text-blue-500",
    details: ["Problem Definition", "Workflow Analysis", "Technology Audit"],
  },
  {
    id: 2,
    title: "02 — Architect",
    timeframe: "Phase 2",
    icon: PenTool,
    description: "We design the AI, software, infrastructure and hardware solution.",
    color: "from-indigo-500/20 to-indigo-500/0",
    iconColor: "text-indigo-500",
    details: ["System Architecture", "Security & Data Plan", "Commercial Proposal"],
  },
  {
    id: 3,
    title: "03 — Build",
    timeframe: "Phase 3",
    icon: Code2,
    description: "We develop and validate the system through iterative releases.",
    color: "from-amber-500/20 to-amber-500/0",
    iconColor: "text-amber-500",
    details: ["Iterative Development", "Hardware Validation", "Early MVP"],
  },
  {
    id: 4,
    title: "04 — Deploy",
  ...
  },
  {
    ...
    timeframe: "Phase 5",
    icon: ShieldCheck,
    description: "We provide support, monitoring and continuous improvement.",
    color: "from-primary/20 to-primary/0",
    iconColor: "text-primary",
    details: ["System Monitoring", "SLA Support", "Continuous Upgrades"],
  },
];
