...
import { Terminal, HardDrive, Workflow, AlertCircle, RefreshCw, Check, ChevronDown, Download, Info, Code, Cpu, Shield, Zap, X, Wrench, Folder, Package, FileArchive } from "lucide-react";

export default function NitiLandingPage() {
  const [selectedDevice, setSelectedDevice] = useState("niti-core");
